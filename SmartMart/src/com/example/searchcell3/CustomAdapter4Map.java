...
public class CustomAdapter4Map extends ArrayAdapter<ListViewCustom1> {
		...
		CustomAdapter4Map (ArrayList<ListViewCustom1> d, Context c, int textViewResourceId) {
